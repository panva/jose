...
import { sign as jwsSign, verify as jwsVerify } from './lib/signing.js'
import { jwsAlgorithm } from './lib/jws_algorithms.js'
import type { JWSAlgorithm } from './lib/jws_algorithms.js'
import { JOSENotSupported } from './util/errors.js'

/**
 * Identifiers from the IANA "HTTP Signature Algorithms" registry that this module implements.
 *
 * {@link types.JWSAlgorithm JWS algorithm identifiers} are accepted as well, as permitted by
 * {@link https://www.rfc-editor.org/info/rfc9421/#section-3.3.7 RFC 9421 Section 3.3.7}.
 *
 * @ignore
 */
...
function jwa(alg: unknown): JWSAlgorithm {
  ...
  try {
    return jwsAlgorithm(registry[alg] ?? alg)
  } catch (err) {
