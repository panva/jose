...
[createRemoteJWKSet](../../../jwks/remote/functions/createRemoteJWKSet.md) and
[createLocalJWKSet](../../../jwks/local/functions/createLocalJWKSet.md) examples. Empty on manually constructed
errors.
