# Interface: ComposedJWTDecryptGetKey()\<Factories, KeyType\>
...
▸ **ComposedJWTDecryptGetKey**(`protectedHeader`, `token`): [`JWK`](../../../../types/type-aliases/JWK.md) \| [`KeyObject`](../../../../types/interfaces/KeyObject.md) \| `KeyType` \| [`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<[`JWK`](../../../../types/type-aliases/JWK.md) \| [`KeyObject`](../../../../types/interfaces/KeyObject.md) \| `KeyType`\>
...
| ------ | ------ | ------ |
| `protectedHeader` | [`ComposedCompactJWEHeader`](ComposedCompactJWEHeader.md) | JWE or JWS Protected Header. |
