# Function: composeGeneralEncrypt()

## [💗 Help the project](https://github.com/sponsors/panva)

Support from the community to continue maintaining and improving this module is welcome. If you find the module useful, please consider supporting the project by [becoming a sponsor](https://github.com/sponsors/panva).

▸ **composeGeneralEncrypt**\<`Factories`\>(...`factories`): [`ComposedGeneralEncryptConstructor`](../interfaces/ComposedGeneralEncryptConstructor.md)\<[`ComposedJWEHeader`](../../../flattened/encrypt/interfaces/ComposedJWEHeader.md)\<`Factories`\>\>
...
[`ComposedGeneralEncryptConstructor`](../interfaces/ComposedGeneralEncryptConstructor.md)\<[`ComposedJWEHeader`](../../../flattened/encrypt/interfaces/ComposedJWEHeader.md)\<`Factories`\>\>
