...
**`example`** Deno import
```js
import { createRemoteJWKSet } from 'https://deno.land/x/jose@v3.16.0/jwks/remote.ts'
```
...
[jwks/remote.ts:256](https://github.com/panva/jose/blob/v3.16.0/src/jwks/remote.ts#L256)
