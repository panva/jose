...
**`example`** Deno import
```js
import { createRemoteJWKSet } from 'https://deno.land/x/jose@v3.15.1/jwks/remote.ts'
```
...
[jwks/remote.ts:258](https://github.com/panva/jose/blob/v3.15.1/src/jwks/remote.ts#L258)
