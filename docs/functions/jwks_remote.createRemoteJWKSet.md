...
**`example`** Deno import
```js
import { createRemoteJWKSet } from 'https://deno.land/x/jose@v3.18.0/jwks/remote.ts'
```
...
[jwks/remote.ts:257](https://github.com/panva/jose/blob/v3.18.0/src/jwks/remote.ts#L257)
