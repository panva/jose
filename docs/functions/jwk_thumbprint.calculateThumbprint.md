...
**`example`** Deno import
```js
import { calculateThumbprint } from 'https://deno.land/x/jose@v3.15.4/jwk/thumbprint.ts'
```
...
[jwk/thumbprint.ts:49](https://github.com/panva/jose/blob/v3.15.4/src/jwk/thumbprint.ts#L49)
