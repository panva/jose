...
**`example`** Deno import
```js
import { calculateThumbprint } from 'https://deno.land/x/jose@v3.16.0/jwk/thumbprint.ts'
```
...
[jwk/thumbprint.ts:49](https://github.com/panva/jose/blob/v3.16.0/src/jwk/thumbprint.ts#L49)
