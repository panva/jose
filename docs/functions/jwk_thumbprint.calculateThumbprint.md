...
**`example`** Deno import
```js
import { calculateThumbprint } from 'https://deno.land/x/jose@v3.15.2/jwk/thumbprint.ts'
```
...
[jwk/thumbprint.ts:49](https://github.com/panva/jose/blob/v3.15.2/src/jwk/thumbprint.ts#L49)
