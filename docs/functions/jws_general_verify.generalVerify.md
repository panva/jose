...
**`example`** Deno import
```js
import { generalVerify } from 'https://deno.land/x/jose@v3.16.1/jws/general/verify.ts'
```
...
[jws/general/verify.ts:65](https://github.com/panva/jose/blob/v3.16.1/src/jws/general/verify.ts#L65)
