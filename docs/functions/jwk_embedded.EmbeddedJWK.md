...
**`example`** Deno import
```js
import { EmbeddedJWK } from 'https://deno.land/x/jose@v3.15.5/jwk/embedded.ts'
```
...
[jwk/embedded.ts:43](https://github.com/panva/jose/blob/v3.15.5/src/jwk/embedded.ts#L43)
