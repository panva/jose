...
**`example`** Deno import
```js
import { compactVerify } from 'https://deno.land/x/jose@v3.15.4/jws/compact/verify.ts'
```
...
[jws/compact/verify.ts:56](https://github.com/panva/jose/blob/v3.15.4/src/jws/compact/verify.ts#L56)
