...
**`example`** Deno import
```js
import { compactVerify } from 'https://deno.land/x/jose@v3.16.0/jws/compact/verify.ts'
```
...
[jws/compact/verify.ts:56](https://github.com/panva/jose/blob/v3.16.0/src/jws/compact/verify.ts#L56)
