...
**`example`** Deno import
```js
import { generateSecret } from 'https://deno.land/x/jose@v3.15.5/util/generate_secret.ts'
```
...
[util/generate_secret.ts:43](https://github.com/panva/jose/blob/v3.15.5/src/util/generate_secret.ts#L43)
