...
**`example`** Deno import
```js
import { compactDecrypt } from 'https://deno.land/x/jose@v3.17.0/jwe/compact/decrypt.ts'
```
...
[jwe/compact/decrypt.ts:52](https://github.com/panva/jose/blob/v3.17.0/src/jwe/compact/decrypt.ts#L52)
