...
**`example`** Deno import
```js
import { compactDecrypt } from 'https://deno.land/x/jose@v3.15.5/jwe/compact/decrypt.ts'
```
...
[jwe/compact/decrypt.ts:52](https://github.com/panva/jose/blob/v3.15.5/src/jwe/compact/decrypt.ts#L52)
