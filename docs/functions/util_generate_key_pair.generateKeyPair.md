...
**`example`** Deno import
```js
import { generateKeyPair } from 'https://deno.land/x/jose@v3.15.3/util/generate_key_pair.ts'
```
...
[util/generate_key_pair.ts:71](https://github.com/panva/jose/blob/v3.15.3/src/util/generate_key_pair.ts#L71)
