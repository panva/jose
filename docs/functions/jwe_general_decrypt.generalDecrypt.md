...
**`example`** Deno import
```js
import { generalDecrypt } from 'https://deno.land/x/jose@v3.16.0/jwe/general/decrypt.ts'
```
...
[jwe/general/decrypt.ts:69](https://github.com/panva/jose/blob/v3.16.0/src/jwe/general/decrypt.ts#L69)
