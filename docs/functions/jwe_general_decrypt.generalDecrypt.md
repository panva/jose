...
**`example`** Deno import
```js
import { generalDecrypt } from 'https://deno.land/x/jose@v3.17.0/jwe/general/decrypt.ts'
```
...
[jwe/general/decrypt.ts:69](https://github.com/panva/jose/blob/v3.17.0/src/jwe/general/decrypt.ts#L69)
