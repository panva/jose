...
**`example`** Deno import
```js
import { fromKeyLike } from 'https://deno.land/x/jose@v3.15.3/jwk/from_key_like.ts'
```
...
[jwk/from_key_like.ts:33](https://github.com/panva/jose/blob/v3.15.3/src/jwk/from_key_like.ts#L33)
