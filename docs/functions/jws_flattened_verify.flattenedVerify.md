...
**`example`** Deno import
```js
import { flattenedVerify } from 'https://deno.land/x/jose@v3.15.1/jws/flattened/verify.ts'
```
...
[jws/flattened/verify.ts:71](https://github.com/panva/jose/blob/v3.15.1/src/jws/flattened/verify.ts#L71)
