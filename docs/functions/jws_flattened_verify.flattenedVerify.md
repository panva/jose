...
**`example`** Deno import
```js
import { flattenedVerify } from 'https://deno.land/x/jose@v3.17.0/jws/flattened/verify.ts'
```
...
[jws/flattened/verify.ts:71](https://github.com/panva/jose/blob/v3.17.0/src/jws/flattened/verify.ts#L71)
