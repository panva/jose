...
**`example`** Deno import
```js
import { flattenedDecrypt } from 'https://deno.land/x/jose@v3.16.1/jwe/flattened/decrypt.ts'
```
...
[jwe/flattened/decrypt.ts:81](https://github.com/panva/jose/blob/v3.16.1/src/jwe/flattened/decrypt.ts#L81)
