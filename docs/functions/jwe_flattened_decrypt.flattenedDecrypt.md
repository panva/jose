...
**`example`** Deno import
```js
import { flattenedDecrypt } from 'https://deno.land/x/jose@v3.17.0/jwe/flattened/decrypt.ts'
```
...
[jwe/flattened/decrypt.ts:80](https://github.com/panva/jose/blob/v3.17.0/src/jwe/flattened/decrypt.ts#L80)
