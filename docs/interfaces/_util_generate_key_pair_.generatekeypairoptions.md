...
*Defined in [src/util/generate_key_pair.ts:10](https://github.com/panva/jose/blob/v3.7.1/src/util/generate_key_pair.ts#L10)*
...
*Defined in [src/util/generate_key_pair.ts:16](https://github.com/panva/jose/blob/v3.7.1/src/util/generate_key_pair.ts#L16)*
