...
Defined in: [util/generate_key_pair.ts:10](https://github.com/panva/jose/blob/main/src/util/generate_key_pair.ts#L10)
...
Defined in: [util/generate_key_pair.ts:16](https://github.com/panva/jose/blob/main/src/util/generate_key_pair.ts#L16)
