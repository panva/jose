...
**`example`** Deno import
```js
import { CompactSign } from 'https://deno.land/x/jose@v3.15.1/jws/compact/sign.ts'
```
...
[jws/compact/sign.ts:39](https://github.com/panva/jose/blob/v3.15.1/src/jws/compact/sign.ts#L39)
...
[jws/compact/sign.ts:48](https://github.com/panva/jose/blob/v3.15.1/src/jws/compact/sign.ts#L48)
...
[jws/compact/sign.ts:59](https://github.com/panva/jose/blob/v3.15.1/src/jws/compact/sign.ts#L59)
