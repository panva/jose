...
**`example`** Deno import
```js
import { FlattenedSign } from 'https://deno.land/x/jose@v3.16.1/jws/flattened/sign.ts'
```
...
[jws/flattened/sign.ts:51](https://github.com/panva/jose/blob/v3.16.1/src/jws/flattened/sign.ts#L51)
...
[jws/flattened/sign.ts:63](https://github.com/panva/jose/blob/v3.16.1/src/jws/flattened/sign.ts#L63)
...
[jws/flattened/sign.ts:76](https://github.com/panva/jose/blob/v3.16.1/src/jws/flattened/sign.ts#L76)
...
[jws/flattened/sign.ts:90](https://github.com/panva/jose/blob/v3.16.1/src/jws/flattened/sign.ts#L90)
