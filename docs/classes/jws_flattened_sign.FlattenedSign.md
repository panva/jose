...
**`example`** Deno import
```js
import { FlattenedSign } from 'https://deno.land/x/jose@v3.15.4/jws/flattened/sign.ts'
```
...
[jws/flattened/sign.ts:51](https://github.com/panva/jose/blob/v3.15.4/src/jws/flattened/sign.ts#L51)
...
[jws/flattened/sign.ts:60](https://github.com/panva/jose/blob/v3.15.4/src/jws/flattened/sign.ts#L60)
...
[jws/flattened/sign.ts:73](https://github.com/panva/jose/blob/v3.15.4/src/jws/flattened/sign.ts#L73)
...
[jws/flattened/sign.ts:87](https://github.com/panva/jose/blob/v3.15.4/src/jws/flattened/sign.ts#L87)
