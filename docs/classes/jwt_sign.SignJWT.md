...
**`example`** Deno import
```js
import { SignJWT } from 'https://deno.land/x/jose@v3.15.0/jwt/sign.ts'
```
...
[jwt/sign.ts:46](https://github.com/panva/jose/blob/v3.15.0/src/jwt/sign.ts#L46)
...
[jwt/sign.ts:57](https://github.com/panva/jose/blob/v3.15.0/src/jwt/sign.ts#L57)
