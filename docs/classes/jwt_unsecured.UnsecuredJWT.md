...
**`example`** Deno import
```js
import { UnsecuredJWT } from 'https://deno.land/x/jose@v3.17.0/jwt/unsecured.ts'
```
...
[jwt/unsecured.ts:58](https://github.com/panva/jose/blob/v3.17.0/src/jwt/unsecured.ts#L58)
...
[jwt/unsecured.ts:71](https://github.com/panva/jose/blob/v3.17.0/src/jwt/unsecured.ts#L71)
