...
**`example`** Deno import
```js
import { UnsecuredJWT } from 'https://deno.land/x/jose@v3.15.3/jwt/unsecured.ts'
```
...
[jwt/unsecured.ts:57](https://github.com/panva/jose/blob/v3.15.3/src/jwt/unsecured.ts#L57)
...
[jwt/unsecured.ts:70](https://github.com/panva/jose/blob/v3.15.3/src/jwt/unsecured.ts#L70)
