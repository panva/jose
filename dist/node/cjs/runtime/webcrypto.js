...
exports.getKeyObject = exports.checkCryptoKey = exports.isCryptoKey = void 0;
...
function checkCryptoKey(key, alg, ...usages) {
    switch (alg) {
        case undefined:
            break;
        case 'HS256':
...
exports.checkCryptoKey = checkCryptoKey;
function getKeyObject(key, alg, ...usages) {
