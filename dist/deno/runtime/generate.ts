import { isCloudflareWorkers, isNodeJs } from './global.ts'
import crypto from './webcrypto.ts'
import { JOSENotSupported } from '../util/errors.ts'
import random from './random.ts'
import type { GenerateKeyPairOptions } from '../util/generate_key_pair.ts'
import type { GenerateSecretOptions } from '../util/generate_secret.ts'
