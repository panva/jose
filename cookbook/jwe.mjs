export default [
  ...
  {
    title:
      'https://datatracker.ietf.org/doc/html/draft-ietf-jose-hpke-pq-pqt#appendix-A - HPKE-8 Integrated Encryption',
    input: {
      plaintext:
        'You can trust us to stick with you through thick and thin–to the bitter end. And you can trust us to keep any secret of yours–closer than you keep it yourself. But you cannot trust us to let you face trouble alone, and go off without a word. We are your friends, Frodo.',
      key: {
  ...
  {
    title:
      'https://datatracker.ietf.org/doc/html/draft-ietf-jose-hpke-pq-pqt#appendix-A - HPKE-10 Integrated Encryption',
    input: {
      plaintext:
        'You can trust us to stick with you through thick and thin–to the bitter end. And you can trust us to keep any secret of yours–closer than you keep it yourself. But you cannot trust us to let you face trouble alone, and go off without a word. We are your friends, Frodo.',
      key: {
